...
if (!worker.includes('const CACHE = "budget-v159"')) failures.push("서비스 워커 v159 캐시 누락");
...
for (const asset of ["pet-nursery.css", "pet-nursery.js", "pet-nursery-view.js", "pet-nursery-extras.js", "pet-nursery-room.js", "PET_RUNTIME_ASSETS"]) {
